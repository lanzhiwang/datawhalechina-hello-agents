...
class CharacterRoleplayAgent:
    def __init__(self):
        ...
        # 配置 OpenAI 客户端
        client_params = {"api_key": api_key, "model": model_id}
    ...
    def setup_character(self, name, source_material, personality, opening_line=None):
        ...
        print(
            f"💡 {self.character_config['name']}: {self.character_config['opening_line']}"
        )
        print("\n" + "=" * 50)
