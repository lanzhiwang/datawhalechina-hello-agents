...
class VectorStoreManager:
            ...
            try:
                ...
                self.client.create_collection(
                    ...
                    vectors_config=VectorParams(
                        size=1536, distance=Distance.COSINE  # OpenAI embedding维度
                    ),
                )
    ...
    async def add_to_l1(
        ...
        try:
            ...
            self.client.upsert(collection_name=self.l1_collection, points=[point])
    ...
    async def add_to_l2(
        ...
        try:
            ...
            self.client.upsert(collection_name=self.l2_collection, points=[point])
        ...
        try:
            ...
            for result in results:
                ...
                keyword_score = self._calculate_keyword_score(
                    query, f"{payload.get('title', '')} {payload.get('abstract', '')}"
                )
    ...
    async def get_user_vectors(self, user_id: str, limit: int = 100) -> List[Dict]:
        ...
        try:
            ...
            return [{"id": point.id, "payload": point.payload} for point in results[0]]
    ...
    async def delete_user_vectors(self, user_id: str) -> bool:
        ...
        try:
            ...
            self.client.delete(
                collection_name=self.l2_collection, points_selector=user_filter
            )
